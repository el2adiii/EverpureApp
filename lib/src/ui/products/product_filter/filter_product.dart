...
class _FilterProductState extends State<FilterProduct> {
  ...
  @override
  void initState() {
    widget.productsBloc.selectedRange = RangeValues(0, appStateModel.blocks.maxPrice.toDouble());
    super.initState();
  }
            ...
            return Stack(children: <Widget>[
              ...
              Positioned(
                ...
                child: SizedBox(
                  ...
                  child: AccentButton(
                    onPressed: () {
                      widget.productsBloc.applyFilter(widget.productsBloc.selectedRange.start, widget.productsBloc.selectedRange.end);
          ...
          children: <Widget>[
            Container(
              ...
              child: RangeSlider(
                ...
                labels: RangeLabels('${formatter.format(widget.productsBloc.selectedRange.start)}', '${formatter.format(widget.productsBloc.selectedRange.end)}'),
            ...
            Container(
              ...
              child: Row(
                ...
                children: <Widget>[
                  Text('${formatter.format(widget.productsBloc.selectedRange.start)}'),
                  Text('${formatter.format(widget.productsBloc.selectedRange.end)}'),
                ],
              ),
            )
          ],
