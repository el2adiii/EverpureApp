...
class AccentButton extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return _BaseButton(
      ...
      textStyle: TextStyle(
          fontSize: 14.0, color: Theme.of(context).colorScheme.onSecondary, fontWeight: FontWeight.bold),
...
class PrimaryButton extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return _BaseButton(
      ...
      borderRadius: const BorderRadius.all(Radius.circular(5.0)),
      textStyle: TextStyle(
          fontSize: 14.0, color: Theme.of(context).colorScheme.onPrimary, fontWeight: FontWeight.bold),
      text: text,
    );
  }
}
...
class BlackButton extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return _BaseButton(
      ...
      borderRadius: const BorderRadius.all(Radius.circular(5.0)),
      textStyle: TextStyle(
          fontSize: 14.0, color: Theme.of(context).colorScheme.brightness == Brightness.dark ? Colors.black : Colors.white, fontWeight: FontWeight.bold),
      text: text,
      iconData: iconData,
    );
  }
